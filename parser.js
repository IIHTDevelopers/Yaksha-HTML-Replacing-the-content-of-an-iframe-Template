...
const htmlTagsTestCase = {
    ...
    extraParams: [['html', 'body', 'title', 'h1', 'p', 'h2', 'iframe', 'button']]
};
...
const htmlFrameAttributesTestCase = {
    ...
    extraParams: ['iFrame', ['src', 'id']]
};

const htmlButtonAttributesTestCase = {
    testCaseName: 'HTML Button Attributes Test',
    testCaseType: 'boundary',
    testLogic: checkHtmlAttributes,
    extraParams: ['button', ['onclick']]
};
...
function executeAllTestCases() {
    ...
    handleTestCase(filePath, htmlButtonAttributesTestCase.testCaseName, htmlButtonAttributesTestCase.testCaseType, htmlButtonAttributesTestCase.testLogic, htmlButtonAttributesTestCase.extraParams);
}
